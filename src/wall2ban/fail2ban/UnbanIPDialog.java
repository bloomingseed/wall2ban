 ...
 * @author xceeded
 */
public class UnbanIPDialog extends javax.swing.JDialog {

    private boolean formResult;
    /**
     * Creates new form UnbanIPDialog
     */
    public UnbanIPDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
   ...
   public void setDisplayIP(String ip){
       
        this.jLabel1.setText("Unban " + ip + " ?");
   }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnbanIPDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UnbanIPDialog dialog = new UnbanIPDialog(new javax.swing.JFrame(), true);
